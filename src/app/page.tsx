      ...
      <section style={{ padding: "80px 56px 40px" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "end" }}>
          ...
          <div style={{ paddingBottom: 24 }}>
            <p style={{ ...ssBody, fontSize: 29, lineHeight: 1.7, maxWidth: 600, margin: 0 }}>
              ร้านเหล็กเก่าแก่คู่เมืองหาดใหญ่ ศูนย์รวมเหล็กทุกชนิด<br />
              จำหน่ายปลีก-ส่ง บริการ ตัด-พับ พร้อมจัดส่งทั่วประเทศ
            </p>
            <p style={{ ...ssBody, fontSize: 21, lineHeight: 1.7, color: SS.muted, marginTop: 16, maxWidth: 600, fontStyle: "italic" }}>
