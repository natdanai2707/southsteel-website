...
const services: ServiceEntry[] = [
  ...
  },
  {
    ...
    lead: "รถบรรทุก 4 ล้อ 6 ล้อ และ 10 ล้อ ประจำพร้อมส่งทุกวัน ส่งฟรีในพื้นที่หาดใหญ่และใกล้เคียง จัดส่งรวดเร็ว ครอบคลุมสงขลา ภาคใต้ และทั่วประเทศ พร้อมทีมยกของหน้างาน",
    specs: [
      ["พื้นที่ส่งฟรี", "หาดใหญ่และใกล้เคียง"],
      ["รถบรรทุก", "4 ล้อ · 6 ล้อ · 10 ล้อ"],
      ["ระยะเวลา", "จัดส่งรวดเร็ว"],
      ["ครอบคลุม", "ทั่วประเทศ"],
    ],
